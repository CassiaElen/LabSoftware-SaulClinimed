...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtUsuNome.getText().isEmpty()) || (txtUsuFone.getText().isEmpty()) ||  (cboUsoPerfil.getSelectedItem().equals("Selecionar"))  ||(txtUsuLog.getText().isEmpty()) || (txtUsuSen.getText().isEmpty())) {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(10, 300, 990, 210);
        ...
        btnRemover.setBounds(800, 170, 100, 40);
        ...
        btnAlterar1.setBounds(800, 100, 100, 40);
        ...
        btnAdicionar1.setBounds(800, 30, 100, 40);
