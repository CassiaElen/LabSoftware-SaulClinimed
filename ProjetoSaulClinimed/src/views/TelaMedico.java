...
public class TelaMedico extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        ...
        java.util.Date dataJCalenDA = txtMedDA.getDate();
        DateFormat formatador = DateFormat.getDateInstance(DateFormat.SHORT);
        String dataFormatadaDA = formatador.format(dataJCalenDA);

        java.util.Date data = new java.util.Date();
        String dataDesktop = formatador.format(data);

        if (dataFormatadaDA.equals(dataDesktop)) {
            ...
            try {
                ...
                String dia = dataFormatadaDA.substring(0, 2);
                String mes = dataFormatadaDA.substring(3, 5);
                String ano = dataFormatadaDA.substring(6);
                String dataMylql = ano + "-" + mes + "-" + dia;
                pst.setString(6, dataMylql);
                if ((txtMedNom.getText().isEmpty()) || (txtMedCrm.getText().isEmpty()) || (txtMedEma.getText().isEmpty()) || (txtMedEsp.getText().isEmpty()) || (txtMedDA.getDate() == null) || (txtMedTel.getText().isEmpty())) {
    ...
    public void setar_campos() {
        ...
        Date dataDA = (Date) tbtMedico.getModel().getValueAt(setar, 6);
        txtMedDA.setDate(dataDA);
    ...
    private void initComponents() {
        ...
        txtMedDA = new com.toedter.calendar.JDateChooser();
        ...
        txtMedPesquisar.setBounds(70, 300, 500, 30);
        ...
        jScrollPane1.setBounds(10, 340, 990, 170);
        ...
        btnAdicionar.setBounds(860, 40, 100, 40);
        ...
        btnAlterar.setBounds(860, 120, 100, 40);
        ...
        btnRemover.setBounds(860, 200, 100, 40);
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(30, 10, 70, 19);

        txtMedId.setEnabled(false);
        jPanel2.add(txtMedId);
        txtMedId.setBounds(30, 30, 40, 30);

        jLabel2.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 12)); // NOI18N
        jLabel2.setText("*Nome");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(30, 70, 38, 16);
        ...
        txtMedCrm.setBounds(30, 150, 110, 30);

        jLabel10.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 12)); // NOI18N
        jLabel10.setText("*Data de Admissão");
        jPanel2.add(jLabel10);
        jLabel10.setBounds(360, 130, 101, 16);

        txtMedDA.setDateFormatString("dd/MM/yyyy");
        jPanel2.add(txtMedDA);
        txtMedDA.setBounds(360, 150, 140, 30);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 10, 520, 260);
        ...
        txtExaPesExa.setBounds(20, 50, 210, 30);
        ...
        jLabel19.setBounds(20, 30, 74, 16);
        ...
        jScrollPane3.setBounds(20, 90, 210, 150);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(560, 10, 250, 260);
    ...
    private com.toedter.calendar.JDateChooser txtMedDA;
